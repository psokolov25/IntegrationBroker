...
const dictionaries = {
  'ru-RU': {
    ...
    monitoringAdminOpsTitle: 'Метрики admin batch-операций',
    monitoringAdminOpsEmpty: 'Admin batch-операции ещё не выполнялись',
  ...
  'en-EN': {
    ...
    monitoringAdminOpsTitle: 'Admin batch operation metrics',
    monitoringAdminOpsEmpty: 'No admin batch operations executed yet',
