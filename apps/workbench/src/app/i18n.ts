...
const dictionaries = {
  'ru-RU': {
    ...
    navRuntimeRevisions: 'Ревизии Runtime Config',
    ...
    runtimeRevisionsTitle: 'Ревизии runtime-конфигурации',
    ...
    replayBatchLimitLabel: 'Лимит batch replay',
    replayBatchLimitHint: 'Сервер может ограничить лимит',
    replayBatchLimitClamped: 'Лимит был ограничен сервером',
  ...
  'en-EN': {
    ...
    navRuntime: 'Runtime Config',
    navRuntimeRevisions: 'Runtime Config revisions',
    navReplay: 'Replay',
    navGroovy: 'Groovy Tooling',
    ...
    runtimeTitle: 'Runtime Config',
    runtimeRevisionsTitle: 'Runtime config revisions',
    ...
    replayBatchLimitLabel: 'Batch replay limit',
    replayBatchLimitHint: 'Server may clamp the limit',
    replayBatchLimitClamped: 'Limit was clamped by server',
